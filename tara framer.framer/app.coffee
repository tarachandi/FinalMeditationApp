# Import file "MeditationApp_V1_IPHONE6"
# $ = Framer.Importer.load("imported/MeditationApp_V1_IPHONE6@1x")
...
gongMusic = new AudioPlayer audio: "Gong.mp3"
gongMusic.visible = false
meditationMusic = new AudioPlayer audio: "MeditationMusicLong.mp3"
meditationMusic.visible = false
...
$.Play.on Events.Click, ->
	gongMusic.player.play()
	meditationMusic.player.play()
	$.timer.animate
		properties:
			scale: 1, opacity: 0
		time: 1
